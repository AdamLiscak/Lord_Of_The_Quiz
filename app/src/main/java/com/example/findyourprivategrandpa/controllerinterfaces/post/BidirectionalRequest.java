...
public class BidirectionalRequest
{
    /*
    Diese Klasse ist dafür zuständig, dass man eine Nachricht dem Server schicken kann und er uns eine Nachricht
    zurücksendet.
    Die Nachricht, die auf seine URL urlAddresse geschickt wird, wird durch das Eingabeparameter params bezeichnet.
    Die zurückgesendente Nachricht wird über getText() rausgeholt.
    params muss von PostMessageBuilder geliefert werden.
     */
    private String urlAddress;
    private String params;
    public BidirectionalRequest(String urlAddress, String params)
    {
